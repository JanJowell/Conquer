...
class CategoryResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'participation_mode' => $this->participation_mode ?? 'individual',
            'group_min_members' => $this->usesGroupRegistration() ? $this->group_min_members : null,
            'group_max_members' => $this->usesGroupRegistration() ? $this->group_max_members : null,
